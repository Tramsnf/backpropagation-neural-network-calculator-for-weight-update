...
y3_in = v13*h1_out + v23*h2_out
y1_out, y2_out, y3_out = sigmoid(y1_in), sigmoid(y2_in), sigmoid(y3_in)

##targeted output are !!
t1, t2, t3 = 1, 1, 0
#----------------------
e1, e2, e3 = (t1-y1_out), (t2-y2_out), (t3-y3_out)
#print(e1, e2, e3)
...
grad_y3_in = (y3_out * (1-y3_out)) * grad_y3_out

grad_v21 = grad_y1_in * h2_out
grad_v22 = grad_y2_in * h2_out 
grad_v23 = grad_y3_in * h2_out 
#print(grad_v21, grad_v22, grad_v23)

grad_v11 = grad_y1_in * h1_out
grad_v12 = grad_y2_in * h1_out 
grad_v13 = grad_y3_in * h1_out 
#print(grad_v11, grad_v12, grad_v13)

grad_h1_out = grad_y1_in*v11 + grad_y2_in*v12 + grad_y3_in*v13
grad_h2_out = grad_y1_in*v21 + grad_y2_in*v22 + grad_y3_in*v23
...
print("the weight between hidden unit 1 and output unit 3 =", v13)
print("the weight between hidden unit 2 and output unit 1 =", v21)
print("the weight between hidden unit 2 and output unit 2 =", v22)
print("the weight between hidden unit 2 and output unit 3 =", v23)
print(dl)
print(" ")
...
print(dl)
print("Net output unit 3 = ", y3_in)
print("Actual output of output unit 3 = ",y3_out)
print(dl)

print(dl)
print("Delta of output unit 1 = ", grad_y1_in)
print("Delta of output unit 2 = ", grad_y2_in)
print("Delta of output unit 3 = ", grad_y3_in)
print(dl)
print("")
